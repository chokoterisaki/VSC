...
<body>
    ...
    <section class="contenedor_tarjetas">
        <a href="#"><div class="forma">
            <h2>Contacto</h2>
            <h4>Reporta, sugiere los que descubras</h4>
        </div></a>

        <a href=""><div class="forma">
            <h2>Cambiar contraseña</h2>
            <h4>¿Olvidaste tu contraseña?</h4>
            <h4>Contactanos para cambiarla</h4>
        </div></a>

        <a href=""><div class="forma">
            <h2>Solicitud de Administrador</h2>
            <h4>Solicita moderar el chat</h4>
        </div></a>
    </section>
    <footer></footer>
</body>
