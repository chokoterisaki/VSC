if (inicio == true) {
  ...
  switchButton.addEventListener("change", function () {
    if (this.checked) {
      ...
      div6.style.backgroundColor = "#f0f0f0";
    }
  });
  ...
  const switchButton = document.getElementById("switch");
  var div = document.getElementsByClassName("fondox")[0];
  var div1 = document.getElementsByClassName("fondox1")[0];
  var div2 = document.getElementsByClassName("fondox2")[0];
  var div3 = document.getElementsByClassName("fondox3")[0];
  var div4 = document.getElementsByClassName("fondox4")[0];
  //f0f0f0: blanco
  //363439: negro
  div.style.backgroundColor = "#f0f0f0";
  div1.style.backgroundColor = "#f0f0f0";
