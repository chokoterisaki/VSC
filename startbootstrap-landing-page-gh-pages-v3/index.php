...
<body>
            ...
            <nav class="navbar navbar-light bg-light static-top fondo">
                <div class="container">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="../register-login/rp.php">Sobre Nosotros</a>
                        </li>
                    </ul>
    ...
    <!-- Icons Grid-->
    <section class="features-icons fondo2 text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
    ...
    <!-- Testimonials-->
    <section class="testimonials text-center fondo4 ">
        <div class="container">
